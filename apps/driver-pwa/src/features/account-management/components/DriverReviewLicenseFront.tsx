...
import defaultFrontSample from '../../../../../../packages/shared/src/assets/images/webp/drivers-license-front.webp';

export const DriverReviewLicenseFront: React.FC = () => {
...
export default DriverReviewLicenseFront;
